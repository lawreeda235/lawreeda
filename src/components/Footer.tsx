...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/lawreeda235", label: "GitHub" },
    { icon: Linkedin, href: "https://www.linkedin.com/in/lawrence-edaria", label: "LinkedIn" },
    { icon: Mail, href: "mailto: lawrenceedaria277@gmail.com", label: "Email" },
  ];
