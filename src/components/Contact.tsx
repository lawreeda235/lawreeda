  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      value: "lawrenceedaria277@gmail.com",
      link: "mailto:lawrenceedaria278@gmail.com"
    },
    {
      icon: Phone,
      title: "Phone",
      value: "+254 718 984470",
      link: "tel:+254 718 984470"
    },
    {
      icon: MapPin,
      title: "Location",
              ...
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button 
                    ...
                    className="w-full gradient-accent text-accent-foreground hover:shadow-glow transition-all duration-300 disabled:opacity-50"
                  >
